...
@Getter
@Setter
public class ReceiveMoneyTransferOperationModel extends OperationModel {

    private MoneyTransferModel moneyTransfer;

    @Builder
    public ReceiveMoneyTransferOperationModel(BankAccountModel bankAccount, Long bankAccountId, Long amount, OperationSource operationSource, Long fkOperationSource, MoneyTransferModel moneyTransfer) {
